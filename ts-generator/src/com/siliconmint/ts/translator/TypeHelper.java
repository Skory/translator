...
public class TypeHelper {
  ...
  public static String translateType(String type){
    if (objects.contains(type)) {
      return "any";
    } if (primitiveNumbers.contains(type) || objectNumbers.contains(type)) {
      return "number";
  ...
  public static final Set<String> primitiveNumbers = ImmutableSet.of("byte", "char", "short", "int", "long", "float", "double");
